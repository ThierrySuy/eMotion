                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="col-md-4 control-label" for="date_prise">Date de prise du véhicule *</label>
                                                        <div class="col-md-5">
                                                            <input id="date_prise" name="date_prise" type="date" placeholder="Date de prise du véhicule." class="form-control input-md" value="<?php echo $date_prise ?>" required="">
                                                        </div>                                            
                                                        </br>
                                                        <div class="form-group">
                                                            <label class="col-md-4 control-label" for="date_rendu">Date de retour du véhicule *</label>
                                                            <div class="col-md-5">
                                                                <input id="date_rendu" name="date_rendu" type="date" placeholder="Date de retour du véhicule." class="form-control input-md" value="<?php echo $date_rendu ?>" required="">
                                                            </div>        
                                                            </br>
                                                            <div class="form-group">
